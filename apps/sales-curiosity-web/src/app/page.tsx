    ...
    <main className="min-h-screen bg-gradient-to-b from-indigo-950 via-zinc-950 to-black">
      ...
      <section className="relative isolate overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 sm:py-20">
          <div className="flex flex-col items-start gap-6 sm:flex-row sm:items-end sm:justify-between">
            ...
            <a href="/admin" className="rounded-md border border-white/10 bg-white/5 px-4 py-2 text-sm text-white backdrop-blur transition hover:bg-white/10">Go to Admin →</a>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-16">
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          {/* Drafter */}
          <div className="lg:col-span-2 rounded-2xl border border-white/10 bg-white/5 p-5 shadow-lg backdrop-blur dark:border-white/10">
