  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    @media print {
      ...
      .profile-info { page-break-inside: avoid; box-shadow: none; }
...
<body>
  <h1>🤖 Sales Intelligence Report</h1>
  <p style="color: #666666; font-style: italic;">AI-Powered LinkedIn Analysis by Sales Curiosity</p>
  ...
  <div class="profile-info">
    ...
    <p><strong>Headline:</strong> ${profileData?.headline || 'N/A'}</p>
    <p><strong>Location:</strong> ${profileData?.location || 'N/A'}</p>
    <p><strong>LinkedIn:</strong> ${profileData?.url || currentUrl}</p>
    <p><strong>Generated:</strong> ${new Date().toLocaleString()}</p>
  </div>
